...
public class AmidstMenuBuilder {
    ...
    private JMenu create_Salt_Change() {
        JMenu result = new JMenu("Salts Change");
        result.setMnemonic(KeyEvent.VK_H);
        // @formatter:off
        Menus.item(result, actions::changeSaltMonument, "Change salt Monuments", KeyEvent.VK_0);
        Menus.item(result, actions::changeSaltVillage, "Change salt Villages", KeyEvent.VK_1);
        Menus.item(result, actions::changeSaltFeature, "Change salt Features", KeyEvent.VK_2);
        Menus.item(result, actions::changeSaltSlime, "Change salt Slime Chunks", KeyEvent.VK_3);
        // @formatter:on
        return result;
    }
}
